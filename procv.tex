...
% - contact Programming 6 7 8 for accept rates
...
\item
  ...
  \emph{Privacy-Respecting Type Error Telemetry at Scale} \hfill \acceptrate{?}
\item
  ...
  \emph{Conceptual Mutation Testing for Student Programming Misconceptions} \hfill \acceptrate{?}
\item
...
\item
  Ben Greenman, Sam Saarinen, Tim Nelson, \hfill \href{https://2023.programming-conference.org/}{Programming 7.2, March 2023} \\
   and Shriram Krishnamurthi  \\ 
    \emph{Little Tricky Logic: Misconceptions in the Understanding of LT\/L} \hfill \acceptrate{?}
\item
  ...
  Aniket Panse, and Shriram Krishnamurthi \\
    \emph{Gradual Soundness: Lessons from Static Python} \hfill \acceptrate{?}
\item
...
\item
  Ben Greenman \hfill \href{https://pldi22.sigplan.org/}{PLDI 2022} \\
    \emph{Deep and Shallow Types for Gradual Languages} \hfill \acceptrate{?}
\item
...
\item
  ...
  \emph{Complete Monitors for Gradual Types} \hfill \acceptrate{?}
\item
  ...
  \emph{The Behavior of Gradual Types: A User Study} \hfill \acceptrate{?}
\item
  ...
  \emph{Collapsible Contracts: Fixing a Pathology of Gradual Typing} \hfill \acceptrate{?}
\item
...
\item
  ...
  \emph{On the Cost of Type-Tag Soundness} \hfill \acceptrate{?}
\item
  ...
  and Asumu Takikawa. \\
  \emph{Migratory Typing: 10 Years Later} \hfill \acceptrate{?}
\item
  Stephen Chang, Ben Greenman, and Alex Knauth. \hfill \href{https://popl17.sigplan.org/}{POPL 2017} \\
   \emph{Type Systems as Macros} \hfill \acceptrate{?}
\item
  Asumu Takikawa, Daniel Feltey, Ben Greenman, Max S. New, Jan Vitek, \hfill \href{https://popl16.sigplan.org/}{POPL 2016} \\
   ...
   \emph{Is Sound Gradual Typing Dead?} \hfill \acceptrate{?}
\item
  Ben Greenman, Fabian Muehlboeck, and Ross Tate. \hfill \href{https://conferences.inf.ed.ac.uk/pldi2014/}{PLDI 2014} \\
  \emph{Getting F-Bounded Polymorphism into Shape} \hfill \acceptrate{?}
\end{itemize}
